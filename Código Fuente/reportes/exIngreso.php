...
$logo = "logo.jpg";
$ext_logo = "jpg";
$empresa = "Creaciones Encantadas, S.A. de C.V.";
$documento = "CEN210131000";
$direccion = "Camino Real al Ajusco 47, CDMX 16029";
$telefono = "55 23 33 31 31";
$email = "creaciones_encantadas@gmail.com";
...
while ($regd = $rsptad->fetch_object()) {
  $line = array( "CODIGO"=> "$regd->articulo",
                "DESCRIPCION"=> utf8_decode("$regd->color"),
