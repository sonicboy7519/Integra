...
<html>
  <head>
    ...
    <title>Creaciones Encantadas - Integra SIA V1.1.0</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Integra SIA</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Integra SIA</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small>Integra SIA V1.1.0</small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="acerca.php">
                ...
                <small class="label pull-right bg-yellow">SIA</small>
              </a>
            </li>
